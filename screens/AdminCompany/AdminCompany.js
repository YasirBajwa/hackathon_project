...
import styles from './adminCompanyStyle';
import {connect} from 'react-redux';
import {login_user} from './../../store/action/action';

const AdminCopmany = (props,navigation) =>{
    ...
    const handleSubmit = (evt,navigation) => {
     ...
     return(
        ...
        <View  >
        <View >
              <TouchableOpacity style={styles.submit__btn}  >
                <Text style={styles.submit__btn__txt} >View Company</Text>
              </TouchableOpacity>
...
export default connect(mapStateToProps,mapDispatchToProps)(AdminCopmany);